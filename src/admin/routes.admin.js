...
// Customers
router.get('/customers', AdminAuth, wrapAsync(adminController.getCustomers));
router.get('/customers/:customerId', AdminAuth, wrapAsync(adminController.getCustomerById));
